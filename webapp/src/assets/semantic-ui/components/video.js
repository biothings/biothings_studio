  ...
  $.fn.video = function (parameters) {
    ...
    $allModules
      .each(function () {
        ...
        var $playButton = $module.find(selector.playButton)
        ...
        module = {
          ...
          create: function () {
            ...
            var html = templates.video(image)
          ...
          play: function () {
            ...
            var url = $module.data(metadata.url) || false
            var id = $module.data(metadata.id) || false
            ...
            url: function (source) {
              var
                api = (settings.api)
                  ? 1
                  : 0
              var autoplay = (settings.autoplay === 'auto')
                ? ($module.data('image') !== undefined)
                : settings.autoplay
              var hd = (settings.hd)
                ? 1
                : 0
              var showUI = (settings.showUI)
                ? 1
                : 0
              // opposite used for some params
              var hideUI = !(settings.showUI)
                ? 1
                : 0
              var url = ''
