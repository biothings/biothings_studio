        ...
        <div class="ui container menu pagination" v-if="content && content.length">
            <ul class="item m-0">
                <li :class="{'disabled' : page <= 1}">
                    <button class="ui button mini"  @click.prevent="prevPage()">
                        <i class="arrow circle left icon"></i> Previous 
                    </button>
                </li>
                <template v-if="groupPages">
                    <li v-show="!startCapLimitReached">
                        <a  class="ui button mini p-1" @click.prevent="previousGroup()">Previous 20</a>
                    </li>
                </template>
                ...
                <template v-if="groupPages">
                    <li v-show="!endCapLimitReached">
                        <a  class="ui button mini p-1" @click.prevent="nextGroup()">next 20</a>
                    </li>
                </template>
                <li :class="{'disabled' : page >= pages}">
                    <button class="ui button mini"  @click.prevent="nextPage()">
            ...
            <div class="item">
                <select class="ui select dropdown m-0" v-model="perPage" @change="calculatePages" id="perPage">
                    ...
                    <option value="10" selected>12 per page</option>
