[![Build Status](https://travis-ci.org/biothings/biothings_studio.svg?branch=0.2a)](https://travis-ci.org/biothings/biothings_studio) ![Docker Pulls](https://img.shields.io/docker/pulls/biothings/biothings-studio)
